...
import CreateNewCustomerBrand from "./CreateNewCustomerBrand";
  ...
  return (
    <div className="min-h-screen text-white pb-60">
      ...
      <style jsx global>{`
        ...
        .field-input {
          @apply rounded-md border border-white/10 bg-black/40 px-3 py-2 outline-none focus:ring-2 focus:ring-fuchsia-500;
        }
      `}</style>
    </div>
  );
